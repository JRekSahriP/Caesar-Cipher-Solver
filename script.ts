const normalTextInput = <HTMLInputElement>document.getElementById("normalText")!;
const encryptedTextInput = <HTMLInputElement>document.getElementById("encryptedText")!;
const shiftValueInput = <HTMLInputElement>document.getElementById("shiftValue")!;

const shiftedTable = document.getElementById("shiftedTable");

const alphabetLength = 26;

const getShiftValue = ():number => {
    let value:number = Number.parseInt(shiftValueInput.value);
...
const processMessage = (message:string, shift:number):string => {
...
const processChar = (character:string, shift:number):string => {
